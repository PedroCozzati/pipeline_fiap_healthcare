...
from app.clients.services import storage_client, prediction_client, auth_client
...
async def health():
     ...
     for name, client in [("auth", auth_client), ("storage", storage_client), ("prediction", prediction_client)]:
          try:
